    ...
    return (
        <div className="mt-5">
            ...
            <div className="d-flex flex-row flex-wrap justify-content-center mt-5">
                ...
                <p className="text-light mt-3">I still believe that most great ideas start on paper. I start there because paper wireframing gives you a clear goal that you can refere back to at anypoint, it is accessible, and it can catch errors in design fom the start.  </p>
            </div>
        </div>
    )
}
