    ...
    return(
        <div >
            ...
            <div className="d-flex flex-column mb-5 mt-5">
                <div className="card m-4 d-flex flex-row" style={{height: 20 + 'rem'}}>
                ...
                <div className="card d-flex flex-row m-4" style={{height: 20 + 'rem'}}>
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            <img src={props.logo} width="100" height="70"  alt="" />
                            <div className="d-flex flex-column">
                                <Link to="/do" className="btn repo-btn p-2 m-2">For Case Study</Link>
                            </div>                        
                        </div>
                    </div>
                </div>
